...
do
    ...
    do
        ...
        python run.py -ml 10 -ms 3 -fsigma 3 -fmu 5 -fit 0 -fn "../result/${date}/CSV/Threshold/cost_${COST}_$V" -ft 0 -sel 0 -max 1000 -fs 3 -c $COST
    done
done
...
python plot.py -inf ../result/${date}/CSV/Threshold/cost_*_*.csv -out ../result/${date}/plot/Threshold/cost/cost_test_max_3000 -t 0 -ing ../result/${date}/CSV/Threshold/last_cost_*_*.csv
echo "finished $c"